...
-- ALSAbar
local volumeA = lain.widget.alsabar()
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Each screen has its own tag table.0
    ...
    -- s.wiboxt = awful.wibar({ position = "top", screen = s })

    -- Create the bottom wibox
    s.wiboxb = awful.wibar({ position = "bottom", screen = s })
...
globalkeys = gears.table.join(
    ...
    -- awful.key({ modkey, "Shift" }, "Right",     function () awful.tag.incncol( 1, nil, true)    end,
    --           {description = "increase the number of columns", group = "layout"}),
    -- awful.key({ modkey, "Shift" }, "Left",     function () awful.tag.incncol(-1, nil, true)    end,
   ...
   --  awful.key({ modkey }, "r",
    ...
    -- Firefox
    awful.key({ modkey }, "b",
    	function () awful.spawn("firefox-developer-edition") end,
    		{description = "run firefox dev edition", group = "applications"}),
    
    -- File Manager (thunar)
    awful.key({ modkey }, "v",
    	function () awful.spawn("thunar") end,
    		{description = "run thunar filemanager", group = "applications"}),
...
-- Autostart apps
autoscript = "sh ~/.config/awesome/autostart.sh"
awful.spawn.with_shell(autoscript)
